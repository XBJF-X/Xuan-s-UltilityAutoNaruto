...
- [x] 小队突袭（自定义次数，自定义是否需要勾选四倍，**需要填写二级密码，以及保证有足够金币**）
...
- [x] 每日胜场（自动刷胜场直到今日所有宝箱领取完成，支持自定义个人键位，**需要关闭“只匹配玩家”**）
- [x] 生存挑战（自动扫荡/重置，**建议战力足够扫荡到15关的开启，否则收益不如手打**）
- [x] 秘境探险（不停刷落岩秘境，直到用完所有探险券）
...
- [x] 每周胜场（自动刷胜场直到周胜满，**需要自己领取周胜奖励**，程序只负责刷胜场，**需要关闭“只匹配玩家”**）
- [ ] 更多玩法
- [x] 忍法帖点赞分享（自动给忍法帖排行榜点赞并分享，**需要模拟器安装qq**）
